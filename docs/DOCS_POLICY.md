...
Keep project documentation complete, clear, and low-overhead.

## Canonical documentation location

Canonical contributor and governance documentation lives in the repository:
...
These files are versioned, reviewable via PR, and tied to code changes.
